...
import { FaArrowRight, FaUsers, FaHandshake, FaGift } from 'react-icons/fa';

const JoinUsDropdown: React.FC = () => {
  const menuItems = [
    {
      title: 'Why RYGNeco?',
      href: '/join-us#why-rygneco',
      icon: FaUsers,
      color: 'text-blue-600',
      bgColor: 'bg-blue-50'
    },
    {
      title: 'Recycling Made Accessible',
      href: '/join-us#recycling-accessible',
      icon: FaHandshake,
      color: 'text-green-600',
      bgColor: 'bg-green-50'
    },
    {
      title: 'Recycling Offers',
      href: '/join-us#recycling-offers',
      icon: FaGift,
