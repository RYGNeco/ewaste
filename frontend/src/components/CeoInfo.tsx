      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">XYZ XYZ</h3>
            <p className="text-green-600 font-medium mb-4">Founder & Co-CEO</p>
            ...
            <div className="mt-6 flex space-x-4">
              ...
              >
                ...
                >
                  <path
                    d="M16 8.245V12h3.245c-.199.979-.792 1.798-1.673 2.316l2.613 2.03c1.587-1.464 2.548-3.587 2.548-6.057 0-.551-.051-1.104-.157-1.654L16 8.245z"
                    fill="#3F83F8"
                  />
                  <path
                    d="M10.335 13.304l-1.335 1.04-1.335-1.04C7.244 15.53 7 18 7 18s2.09-.684 3.5-1.171C11.91 17.316 14 18 14 18s-.244-2.47-.665-4.696l-1.335 1.04-1.335-1.04z"
                    fill="#34A853"
                  />
                  <path
                    d="M5.441 12.016c-.774-.538-1.339-1.343-1.566-2.251H1V6.334C1 3.388 3.388 1 6.334 1h14.332C23.612 1 26 3.388 26 6.334v11.332c0 2.946-2.388 5.334-5.334 5.334H6.334C3.388 23 1 20.612 1 17.666V9.765h2.875c.23-.913.8-1.723 1.581-2.261l-2.582-2.01c-1.587 1.464-2.548 3.587-2.548 6.057 0 .551.051 1.104.157 1.654l5.338 1.112z"
                    fill="#4285F4"
                  />
                  <path
                    d="M18.259 6.334c0-.815-.662-1.478-1.478-1.478H10.22c-.816 0-1.478.663-1.478 1.478v2.582l4.305 3.348 4.305-3.348V6.334z"
                    fill="#EA4335"
                  />
                </svg>
              </a>
              <a
                href="https://linkedin.com/in/rygneco-ceo"
                aria-label="LinkedIn"
                className="text-green-600 hover:text-green-800"
              >
                <svg
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">XYZ XYZ</h3>
            <p className="text-green-600 font-medium mb-4">Co-CEO & Head of Operations</p>
            <div className="text-gray-700 space-y-4 text-left">
              <p>
